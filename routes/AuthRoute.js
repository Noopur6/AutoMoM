...
router.post('/register', [
        ...
        check("password", "Password should contain 1 special char,1 upper case letter, 1 number and length of password should be eight characters only").matches(/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9]).{8,8}$/, "i"),
