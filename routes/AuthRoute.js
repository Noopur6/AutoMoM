...
router.post('/register', [
        ...
        check("password", "Password should be combination of one uppercase , one lower case, one special char, one digit and eight char long").matches(/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9]).{8,8}$/, "i"),
